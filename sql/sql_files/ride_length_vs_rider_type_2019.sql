...
SELECT 
    ...
    END AS user_type,
    CASE 
        WHEN trip_duration < 300 THEN 'Very Short (<5 min)'
        WHEN trip_duration BETWEEN 300 AND 900 THEN 'Short (5-15 min)'
        WHEN trip_duration BETWEEN 901 AND 1800 THEN 'Medium (15-30 min)'
        WHEN trip_duration BETWEEN 1801 AND 3600 THEN 'Long (30-60 min)'
